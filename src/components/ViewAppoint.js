          ...
          <div className='view-container'>
            {this.state.loading ? (
              ...
              <div className='record-subsection'>
                    ...
                    {this.state.displayDemographic ? 'Hide' : 'Show'} Appointments
                    </button>
                ...
                {this.state.displayDemographic && (
                  <div className='record-subsection'>
                    ...
                    <div className='data-pair'>
                      ...
                      <div className='data-text'>{post.time}</div>
                    </div>
                    <div className='data-pair'>
                    ...
                    <div className='data-pair'>
                      ...
                      <div className='data-text'>{post.status}</div>
                    </div>
                    <div className='data-pair'>
                      <label className='label-text'>Followup</label>
                      <div className='data-text'>{post.followup}</div>
                    </div>
                    <div className='data-pair'>
                      <label className='label-text'>Notes</label>
                      <div className='data-text'>{post.notes}</div>
                    </div>
                      </div>
                    ))}
                  </div>
